...
const styles = `
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .service-price {
    ...
    font-size: 13px; color: var(--green-light); letter-spacing: 0.05em; text-transform: uppercase;
  }
  ...
  return (
    <>
      ...
      <div className="hero">
        ...
        <p className="hero-sub">Professional tree removal, trimming, and emergency service. Free estimates on every job. Licensed & insured. Fast response throughout Florence County.</p>
      ...
      <div className="section section-cream">
        <div className="container">
          ...
          <p className="lead">We serve homeowners and businesses throughout the Pee Dee region. If you're in Florence County or nearby, we've got you covered.</p>
      ...
      <div className="form-section" id="quote">
        <div className="form-wrap">
          ...
          <p className="lead">Tell us about your tree and we'll get back to you fast — usually same day.</p>
          {submitted ? (
            ...
            <form onSubmit={handleSubmit}>
              ...
              <p className="form-note">No obligation. We'll respond same day.</p>
            </form>
          )}
        </div>
      </div>
      ...
      <footer>
        ...
        <p style={{marginTop:'16px'}}>Licensed & Insured · Free Estimates · Serving Florence County</p>
